...
PAGES = [
    ...
    page("gv", "01-viec-can-lam.html", ["GV-01"], "Việc cần làm", "Chỉ việc của Giảng viên; không chứa tác vụ Hội đồng.", rows=[
        row("gv-bm01", "Hoàn thiện BM01A", "Đợt NCKH 2026 · còn 3 ngày", "Cần bạn xử lý", state="open", next_action="Soạn hồ sơ đăng ký", href="03-bm01a.html"),
        row("gv-bm08", "Bổ sung PDF BM08 có chữ ký Chủ nhiệm", "NCKH-GV-2026-014 · V2", "Thiếu bằng chứng", state="blocked", next_action="Tải lên báo cáo tiến độ", href="07-tai-lieu-buoc-03-07.html"),
    ...
    page("gv", "04-de-tai-cua-toi.html", ["GV-05", "GV-06"], "Đề tài của tôi", "Chỉ đề tài làm Chủ nhiệm hoặc được giao Giảng viên hướng dẫn.", active="Đề tài NCKH", visibility="owner-or-advisor", rows=[
        row("gv-topic-1", "NCKH-GV-2026-014 · Thị giác máy tính", "Bạn là Chủ nhiệm đề tài · Bước 04", "Đang thực hiện", state="active", scope="owner", next_action="Quản lý tài liệu", href="07-tai-lieu-buoc-03-07.html"),
        row("gv-topic-2", "NCKH-SV-2026-031 · Gợi ý học tập", "Bạn là Giảng viên hướng dẫn · Bước 01", "Chờ Hội đồng", state="waiting", scope="advisor", next_action="Xét duyệt đề xuất", href="05-xet-ho-so-sinh-vien.html")], tabs=["Cần bạn xử lý", "Tất cả đề tài"]),
    ...
    page("td", "01-viec-can-lam.html", ["TD-01"], "Việc cần làm", "Hồ sơ và BM08 đang chờ đúng đơn vị.", rows=[row("td-hs", "Duyệt HS-GV-2026-042", "Khoa Công nghệ · BM01A V1", "Chờ duyệt", state="open", next_action="Duyệt hồ sơ đăng ký", href="03-duyet-bm01.html"), row("td-bm08", "Ký BM08 NCKH-GV-2026-014", "Khoa Công nghệ · V2", "Chờ ký", state="open", next_action="Ký duyệt báo cáo", href="04-ky-bm08.html")]),
    page("td", "02-hang-cho-xet-duyet.html", ["TD-02"], "Hàng chờ xét duyệt", "Bộ lọc không thể mở đối tượng ngoài Khoa Công nghệ.", active="Xét duyệt", visibility="unit-assignment", rows=[row("td-q1", "HS-GV-2026-042", "Khoa Công nghệ · Nguyễn Thị Lan", "Chờ duyệt", state="open", next_action="Xem & duyệt hồ sơ", href="03-duyet-bm01.html"), row("td-q2", "HS-GV-2026-039", "Khoa Công nghệ · Trần Minh Sơn", "Đã duyệt", state="done")], tabs=["Chờ xử lý", "Đã xử lý"]),
    ...
    page("ct", "01-viec-can-lam.html", ["CT-01"], "Việc cần làm", "Phiếu cá nhân, review Biên bản và chữ ký thứ hai trong assignment.", rows=[row("ct-ballot", "Nộp BM11 của bạn", "HĐNT-2026-006", "Chưa nộp", next_action="Lập và nộp phiếu", href="05-phieu-cua-toi.html"), row("ct-minutes", "Review BM12 V3", "Đã có chữ ký Thư ký", "Chờ Chủ tịch", next_action="Review biên bản họp", href="06-review-bien-ban.html")]),
    page("ct", "02-hoi-dong-cua-toi.html", ["CT-02"], "Hội đồng của tôi", "Chỉ assignment Chủ tịch còn hiệu lực hoặc lịch sử được cấp.", active="Hội đồng của tôi", rows=[row("ct-meeting", "HĐNT-2026-006", "Vai trò: Chủ tịch · Nghiệm thu", "Đang diễn ra", next_action="Xem chi tiết cuộc họp", href="03-chi-tiet-cuoc-hop.html")]),
    page("ct", "03-chi-tiet-cuoc-hop.html", ["CT-03"], "Chi tiết Cuộc họp", "Không có setup, kết thúc hoặc công bố của P.KHCN.", active="Hội đồng của tôi", rows=[row("ct-task", "Phiếu BM11 của tôi", "Official input: BM09 V2 + BM10 hiện hành", "Đã nộp", next_action="Xem phiếu cá nhân", href="05-phieu-cua-toi.html"), row("ct-minute-state", "BM12 V3", "Đã có chữ ký Thư ký", "Chờ review", next_action="Review biên bản", href="06-review-bien-ban.html")]),
    ...
    page("tv", "01-viec-can-lam.html", ["TV-01"], "Việc cần làm", "Chỉ nhiệm vụ phiếu cá nhân của Thành viên.", rows=[row("tv-ballot-task", "Hoàn thiện BM11 của bạn", "HĐNT-2026-006 · Cuộc họp đang diễn ra", "Chưa nộp", next_action="Lập và nộp phiếu đánh giá", href="05-phieu-cua-toi.html")]),
    page("tv", "02-hoi-dong-cua-toi.html", ["TV-02"], "Hội đồng của tôi", "Chỉ assignment Thành viên.", active="Hội đồng của tôi", rows=[row("tv-meeting", "HĐNT-2026-006", "Vai trò: Thành viên · không gồm dữ liệu Hội đồng khác", "Đang diễn ra", next_action="Xem chi tiết cuộc họp", href="03-chi-tiet-cuoc-hop.html")]),
    page("tv", "03-chi-tiet-cuoc-hop.html", ["TV-03"], "Chi tiết Cuộc họp", "Không hiển thị roster progress, phiếu người khác, Biên bản hay tổng hợp trước công bố.", active="Hội đồng của tôi", visibility="member-assignment", rows=[row("tv-personal", "Nhiệm vụ cá nhân", "BM11 của bạn · official input BM09 V2", "Chưa nộp", next_action="Lập phiếu của bạn", href="05-phieu-cua-toi.html")]),
    ...
    page("tk", "01-viec-can-lam.html", ["TK-01"], "Việc cần làm", "Theo dõi Mốc chốt và Biên bản; không có phiếu đánh giá.", rows=[row("tk-wait", "Chờ Mốc chốt HĐNT-2026-006", "4/5 phiếu hợp lệ · bạn không thuộc mẫu số", "Chưa mở Biên bản", state="blocked", next_action="Xem dashboard tiến độ", href="03-dashboard-thu-ky.html")]),
    page("tk", "02-hoi-dong-cua-toi.html", ["TK-02"], "Hội đồng của tôi", "Chỉ assignment Thư ký.", active="Hội đồng của tôi", rows=[row("tk-meeting", "HĐNT-2026-006", "Vai trò: Thư ký · nằm ngoài mẫu số", "Đang diễn ra", next_action="Xem dashboard tiến độ", href="03-dashboard-thu-ky.html")]),
    page("tk", "03-dashboard-thu-ky.html", ["TK-03"], "Dashboard Thư ký", "4/5 chưa tạo Mốc chốt và tuyệt đối chưa cho hoàn tất.", active="Hội đồng của tôi", visibility="secretary-assignment", metrics=[metric("4/5", "Phiếu hợp lệ", "Thư ký ở ngoài mẫu số.", tone="warning"), metric("Chưa lập", "Biên bản BM12", "Chưa có phiên bản mới.", tone="neutral")], gates=[gate("tk-votes", "Đủ 5/5 phiếu hợp lệ", False, "Hiện có 4/5; Thư ký không thuộc mẫu số."), gate("tk-checkpoint", "Mốc chốt phiếu đã tạo", False, "Chỉ hệ thống tạo khi đủ 100%.")], rows=[row("tk-progress", "Tiến độ HĐNT-2026-006", "4/5 người đánh giá đã nộp · Thư ký ở ngoài mẫu số", "Chưa đủ 100%", state="blocked", next_action="Lập biên bản họp", href="05-bien-ban.html")]),
    ...
    page("qt", "01-viec-can-lam.html", ["QT-01"], "Việc cần làm", "Yêu cầu vai trò và tác vụ Tài khoản; không có dữ liệu NCKH.", rows=[row("role-request", "Yêu cầu vai trò Giảng viên · An Nguyễn", "GV-2026-0088 · email đã xác minh", "Chờ duyệt", next_action="Phê duyệt yêu cầu", href="03-duyet-vai-tro.html")]),
...
def render_rows(rows):
    ...
    items = []
    for r in rows:
        show_kicker = not (r["object_type"] == "Nghiệp vụ" and r["version"] == "—" and r["owner"] == "—")
        kicker_html = f'<div class="record-kicker"><span>{esc(r["object_type"])}</span><span>{esc(r["version"])}</span><span>{esc(r["owner"])}</span></div>' if show_kicker else ''
        next_step_html = f'<p class="next-step"><b>Tiếp theo:</b> {esc(r["next_action"])} <a href="{esc(r["href"] or ("#action-target-" + r["id"]))}">Đi đến hành động</a></p>' if r['next_action'] else ''
        items.append(f'''<article class="work-row" id="{esc(r['id'])}" data-record data-state="{esc(r['state'])}" data-row-scope="{esc(r['scope'])}">
          <div>{kicker_html}<h3>{esc(r['title'])}</h3><p>{esc(r['meta'])}</p>{next_step_html}</div><span class="status" data-record-status>{esc(r['status'])}</span>
        </article>''')
...
def main():
    ...
    print(f"OK: {rendered_pages} trang, {sum(len(p['codes']) for p in PAGES)} ma; schema/action/gate hop le" + ("; khong co drift" if args.check else "; da sinh output"))
    return 0
